...
public class Third extends JFrame implements ActionListener{
    ...
    Third(String name){
        ...
        next.setBounds(1000,520,200,35);
        ...
        lifeline.setBounds(1000,565,200,35);
        ...
        submit.setBounds(1000,610,200,35);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()== next){
            ...
            if(bg.getSelection()==null){
                ...
                user_answers[count][0]= bg.getSelection().getActionCommand();
            }
            if(count == 8){
    ...
    public void paint(Graphics g){
        ...
        if(timer>0){
            g.drawString(time,960,510);
        }
        else{
            g.drawString("times up!!",960,510);
        }
